...
function Main() {
  ...
  return (
    <div  >
        <div  >
        <img  className="img" src="https://cdn2.unrealengine.com/Diesel%2Fproductv2%2Fgrand-theft-auto-v%2Fhome%2FGTAV_EGS_Artwork_1920x1080_Hero-Carousel_V06-1920x1080-1503e4b1320d5652dd4f57466c8bcb79424b3fc0.jpg"  />
       ...
       <h4 className='head3'>Terms </h4> <br/>
         ...
         <p className='terms'>5. If haven't register then  go with register and then login .</p> <br/>
         <p className='terms'>5. Once you reach the login page , we provide code  for 30 secendsn before that copy the code  and paste in password area<br/>
           before entering username must be correct.</p> <br/>
       
         </div>
         <label><p className='agree'>Agree with this tearms and conditions</p></label>
          <div className='Input' >
